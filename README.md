...
```text
Enterprise-DevSecOps-Redteam-Lab/
│
├── README.md
├── DISCLAIMER.md
├── QUICKSTART.md
...
│
├── argocd/
│   ├── insecure-application.yaml
│   └── secure-appproject.yaml
│
├── policy-as-code/
│   └── kyverno/
...
├── supply-chain/
│   ├── sbom-summary.md
│   ├── cosign-signing-concept.md
│   └── slsa-mapping.md
│
├── terraform/
│   ├── main.tf
│   ├── insecure-state-risk.md
│   └── remediation.md
│
├── security-scans/
│   ├── semgrep-results.md
...
│
├── attack-scenarios/
│   ├── 01-secret-exposure.md
│   ├── 02-cicd-pipeline-abuse.md
│   ├── 03-container-breakout-risk.md
│   ├── 04-kubernetes-misconfiguration.md
│   └── 05-gitops-deployment-risk.md
│
├── reports/
...
│   ├── devsecops-maturity-assessment.md
│   ├── risk-register.csv
│   ├── retest-report.md
│   ├── remediation-roadmap.md
│   ├── security-control-validation-matrix.md
│   ├── astra-ptaas-alignment.md
│   ├── resume-bullets.md
│   ├── linkedin-post.md
│   └── finding-cards/
│
...
├── scripts/
│   ├── 01-setup-tools.sh
│   ├── 02-security-scans.sh
│   ├── 03-kind-cluster.sh
│   ├── 04-deploy-insecure.sh
│   ├── 05-install-kyverno.sh
│   ├── 06-apply-policies.sh
│   └── 07-deploy-secure.sh
│
└── evidence/
    └── screenshots/
